...
#include "../QtClimaClient/Network/Session.h"
...
QT_MOC_LITERAL(3, 22, 9) // "SessionId"

    },
    "Session\0DataReceived\0\0SessionId"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::DataReceived)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QUuid*>(_v) = _t->SessionId(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setSessionId(*reinterpret_cast< QUuid*>(_v)); break;
        default: break;
        }
