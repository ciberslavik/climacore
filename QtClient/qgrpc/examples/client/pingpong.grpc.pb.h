 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void SayHello(::grpc::ClientContext* context, const ::pingpong::PingRequest* request, ::pingpong::PingReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void GladToSeeMe(::grpc::ClientContext* context, const ::pingpong::PingRequest* request, ::grpc::experimental::ClientReadReactor< ::pingpong::PingReply>* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void GladToSeeYou(::grpc::ClientContext* context, ::pingpong::PingReply* response, ::grpc::experimental::ClientWriteReactor< ::pingpong::PingRequest>* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      virtual void BothGladToSee(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::pingpong::PingRequest,::pingpong::PingReply>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void SayHello(::grpc::ClientContext* context, const ::pingpong::PingRequest* request, ::pingpong::PingReply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void GladToSeeMe(::grpc::ClientContext* context, const ::pingpong::PingRequest* request, ::grpc::experimental::ClientReadReactor< ::pingpong::PingReply>* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void GladToSeeYou(::grpc::ClientContext* context, ::pingpong::PingReply* response, ::grpc::experimental::ClientWriteReactor< ::pingpong::PingRequest>* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void BothGladToSee(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::pingpong::PingRequest,::pingpong::PingReply>* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_SayHello : public BaseClass {
   ...
   public:
    ...
    #endif
                     context, const ::pingpong::PingRequest* request, ::pingpong::PingReply* response) { return this->SayHello(context, request, response); }));}
    void SetMessageAllocatorFor_SayHello(
        ::grpc::experimental::MessageAllocator< ::pingpong::PingRequest, ::pingpong::PingReply>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* SayHello(
      ::grpc::CallbackServerContext* /*context*/, const ::pingpong::PingRequest* /*request*/, ::pingpong::PingReply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* SayHello(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::pingpong::PingRequest* /*request*/, ::pingpong::PingReply* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_GladToSeeMe : public BaseClass {
   ...
   public:
        ...
        MarkMethodCallback(1,
          new ::grpc::internal::CallbackServerStreamingHandler< ::pingpong::PingRequest, ::pingpong::PingReply>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::pingpong::PingRequest* request) { return this->GladToSeeMe(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::pingpong::PingReply>* GladToSeeMe(
      ::grpc::CallbackServerContext* /*context*/, const ::pingpong::PingRequest* /*request*/)
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::pingpong::PingReply>* GladToSeeMe(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::pingpong::PingRequest* /*request*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_GladToSeeYou : public BaseClass {
   ...
   public:
        ...
        MarkMethodCallback(2,
          new ::grpc::internal::CallbackClientStreamingHandler< ::pingpong::PingRequest, ::pingpong::PingReply>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, ::pingpong::PingReply* response) { return this->GladToSeeYou(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::pingpong::PingRequest>* GladToSeeYou(
      ::grpc::CallbackServerContext* /*context*/, ::pingpong::PingReply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerReadReactor< ::pingpong::PingRequest>* GladToSeeYou(
      ::grpc::experimental::CallbackServerContext* /*context*/, ::pingpong::PingReply* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_BothGladToSee : public BaseClass {
   ...
   public:
    ...
    #else
    virtual ::grpc::experimental::ServerBidiReactor< ::pingpong::PingRequest, ::pingpong::PingReply>* BothGladToSee(
