...
void QCliServerPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QCliServerPrivate *_t = static_cast<QCliServerPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject QCliServerPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QCliServerPrivate.data,
      qt_meta_data_QCliServerPrivate,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QGrpcCliServer *_t = static_cast<QGrpcCliServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QGrpcCliServer::*_t)();
        ...
        {
            typedef void (QGrpcCliServer::*_t)(QGrpcCliAbstract::AbstractService * const );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGrpcCliServer::toStop)) {
                *result = 2;
                return;
            }
...
const QMetaObject QGrpcCliServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGrpcCliServer.data,
      qt_meta_data_QGrpcCliServer,  qt_static_metacall, nullptr, nullptr}
};
